...
{   
    $status = "active";
    $sql2 = mysqli_query($dbconnect, "UPDATE registeration SET status = '$status' WHERE userid = '$name' or email = '$name'");
...
<div class="space">
    <div class="top">
    <div class="to-whom" name="chat-box">
        <img src="images/<?php echo $row['image']; ?>" alt="" style="margin-top: 15px;width: 35px; height: 35px; border-radius: 50%;"> <div class="details"><span style="font-size: 18px;font-weight: bolder;"><?php echo $row['userid'] ?></span><p style="font-weight: lighter;color: gray;"><?php echo $row['status']; ?></p> </div>
...
<div class="chat outgoing">
    <div class="details">
    <p>
Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, molestias! Eveniet, neque id ullam tempore, laboriosam ratione iure hic animi facere sint provident fuga tempora obcaecati officiis modi, perspiciatis debitis?
</p>
...
<p>
    ...
    <form action="#" method="post">
        ...
        <div class="footer"><input type="text" class="msg" placeholder="Type here to send message..." required><button type="submit" value="Send" class="send"><i class="fa fa-send-o"></i></button></div>
    </form>
